...
import pool6.BaseObjectPool;
import pool6.ObjectPool;
 ...
 * @version $Revision: 1084555 $ $Date: 2011-03-23 07:04:20 -0500 (Wed, 23 Mar 2011) $
 * @since Pool 1.0
 */
public class GenericObjectPool<T> extends BaseObjectPool<T> implements GenericObjectPoolMBean<T> {
     ...
     * @since Pool 1.5.5
     */
    public void checkRethrow(Throwable t) {
